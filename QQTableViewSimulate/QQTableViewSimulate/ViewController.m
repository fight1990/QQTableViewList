...
- (void)viewDidLoad {
    ...
    NSArray *viewArray = @[message,linkMan,dynamic];
    ...
    NSArray *btnNormalImangs = @[@"message_normal",@"linkman_normal",@"dynamic_normal"];
    NSArray *btnSelectImangs = @[@"message_select",@"linkman_select",@"dynamic_select"];
